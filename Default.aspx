          ...
          <div class="container py-5 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
              <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card text-white" style="background-color: #ffffff;box-shadow: -3px 5px 15px #000000;border: solid 1px #373535;border-radius: 10px;">
                  <br />
                  <div class="card-body text-center" style="height: 450px; padding:10px 50px;">

                    <div class="mb-md-5 pb-5">

                      <img src="Images/LOGOLIV.png" style="width:150px"/>
